...
export default class EastRegion extends Component {
  ...
  render() {
    return(
      <Container>
          <Row>
              <BracketEntry team1="East seed #1" team2="East seed #16" result={this.updateGame1Result}/>
          </Row>
          <Row>
          ...
          <Row>
            <BracketEntry team1="East seed #8" team2="East seed #9" result={this.updateGame2Result}/>
          </Row>
          <Row>
          ...
          <Row>
            <BracketEntry team1="East seed #5" team2="East seed #12" result={this.updateGame3Result}/>
          </Row>
          <Row>
            <Col md= {{span:'2.5', offset: 2}}>
          ...
          <Row>
            <BracketEntry team1="East seed #4" team2="East seed #13" result={this.updateGame4Result}/>
          </Row>
          <Row>
          ...
          <Row>
            <BracketEntry team1="East seed #6" team2="East seed #11" result={this.updateGame5Result}/>
          </Row>
          <Row>
            <Col md= {{span:'2.5', offset: 2}}>
          ...
          <Row>
            <BracketEntry team1="East seed #3" team2="East seed #14" result={this.updateGame6Result}/>
          </Row>
          <Row>
            <Col md= {{span:'2.5', offset: 5}}>
          ...
          <Row>
            <BracketEntry team1="East seed #7" team2="East seed #10" result={this.updateGame7Result}/>
          </Row>
          <Row>
            <Col md= {{span:'2.5', offset: 2}}>
          ...
          <Row>
            <BracketEntry team1="East seed #2" team2="East seed #15" result={this.updateGame8Result}/>
          </Row>
      </Container>
    );
  }
